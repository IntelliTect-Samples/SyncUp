...
namespace IntelliTect.SyncUp.Web.Models
{
    public partial class UserRoleParameter : GeneratedParameterDto<IntelliTect.SyncUp.Data.Models.UserRole>
    {
        ...
        /// </summary>
        public override void MapTo(IntelliTect.SyncUp.Data.Models.UserRole entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override IntelliTect.SyncUp.Data.Models.UserRole MapToNew(IMappingContext context)
        {
            var entity = new IntelliTect.SyncUp.Data.Models.UserRole();
            MapTo(entity, context);
            return entity;
        }
    }

    public partial class UserRoleResponse : GeneratedResponseDto<IntelliTect.SyncUp.Data.Models.UserRole>
    {
        ...
        /// </summary>
        public override void MapFrom(IntelliTect.SyncUp.Data.Models.UserRole obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
            ...
            if (tree == null || tree[nameof(this.Role)] != null)
                this.Role = obj.Role.MapToDto<IntelliTect.SyncUp.Data.Models.Role, RoleResponse>(context, tree?[nameof(this.Role)]);
