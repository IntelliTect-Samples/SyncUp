...
namespace IntelliTect.SyncUp.Data.Migrations
{
    ...
    [Migration("20241116220324_TenantDescription")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntelliTect.SyncUp.Data.Models.Group", b =>
                {
                    ...
                    b.HasIndex("TenantId", "AvatarImageId");
            ...
            modelBuilder.Entity("SyncUp.Data.Models.GroupUser", b =>
                {
                    b.Property<string>("TenantId")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("GroupUserId"));
                    ...
                    b.HasKey("TenantId", "GroupUserId");

                    b.HasAlternateKey("GroupUserId");
            ...
            modelBuilder.Entity("IntelliTect.SyncUp.Data.Models.Group", b =>
                {
                    ...
                    b.HasOne("SyncUp.Data.Models.Image", "AvatarImage")
                        .WithMany()
                        .HasForeignKey("TenantId", "AvatarImageId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("IntelliTect.SyncUp.Data.Models.Tenant", b =>
                {
                    b.HasOne("SyncUp.Data.Models.Image", "BannerImage")
                        .WithOne("Tenant")
                        .HasForeignKey("IntelliTect.SyncUp.Data.Models.Tenant", "TenantId", "BannerImageId")
                        .OnDelete(DeleteBehavior.Restrict);
