...
export const Group = domain.types.Group = {
  ...
  props: {
    ...
    bannerImageId: {
      ...
      get principalType() { return (domain.types.Image as ModelType & { name: "Image" }) },
      get navigationProp() { return (domain.types.Group as ModelType & { name: "Group" }).props.bannerImage as ModelReferenceNavigationProperty },
      hidden: 3 as HiddenAreas,
    },
    bannerImage: {
      name: "bannerImage",
    ...
    avatarImageId: {
      name: "avatarImageId",
      displayName: "Avatar Image Id",
      type: "string",
      role: "foreignKey",
      get principalKey() { return (domain.types.Image as ModelType & { name: "Image" }).props.imageId as PrimaryKeyProperty },
      get principalType() { return (domain.types.Image as ModelType & { name: "Image" }) },
      get navigationProp() { return (domain.types.Group as ModelType & { name: "Group" }).props.avatarImage as ModelReferenceNavigationProperty },
      hidden: 3 as HiddenAreas,
    },
    avatarImage: {
      name: "avatarImage",
      ...
      get typeDef() { return (domain.types.Image as ModelType & { name: "Image" }) },
      role: "referenceNavigation",
      get foreignKey() { return (domain.types.Group as ModelType & { name: "Group" }).props.avatarImageId as ForeignKeyProperty },
      get principalKey() { return (domain.types.Image as ModelType & { name: "Image" }).props.imageId as PrimaryKeyProperty },
      dontSerialize: true,
    },
    description: {
...
export const Tenant = domain.types.Tenant = {
  ...
  props: {
    ...
    bannerImageId: {
      ...
      get principalKey() { return (domain.types.Image as ModelType & { name: "Image" }).props.imageId as PrimaryKeyProperty },
      get principalType() { return (domain.types.Image as ModelType & { name: "Image" }) },
      get navigationProp() { return (domain.types.Tenant as ModelType & { name: "Tenant" }).props.bannerImage as ModelReferenceNavigationProperty },
      hidden: 3 as HiddenAreas,
    },
    bannerImage: {
      name: "bannerImage",
