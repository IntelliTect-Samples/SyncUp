...
{
    public partial class UserInfoParameter : GeneratedParameterDto<IntelliTect.SyncUp.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapTo(IntelliTect.SyncUp.Data.Auth.UserInfo entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override IntelliTect.SyncUp.Data.Auth.UserInfo MapToNew(IMappingContext context)
        {
            var includes = context.Includes;

            var entity = new IntelliTect.SyncUp.Data.Auth.UserInfo()
            {
                Roles = Roles,
    ...
    public partial class UserInfoResponse : GeneratedResponseDto<IntelliTect.SyncUp.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapFrom(IntelliTect.SyncUp.Data.Auth.UserInfo obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
