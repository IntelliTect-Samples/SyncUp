...
namespace IntelliTect.SyncUp.Web.Api
{
    ...
    public partial class UserController
        : BaseApiController<IntelliTect.SyncUp.Data.Models.User, UserParameter, UserResponse, IntelliTect.SyncUp.Data.AppDbContext>
    {
        public UserController(CrudContext<IntelliTect.SyncUp.Data.AppDbContext> context) : base(context)
        {
            GeneratedForClassViewModel = context.ReflectionRepository.GetClassViewModel<IntelliTect.SyncUp.Data.Models.User>();
        }
        ...
        public virtual Task<ItemResult<UserResponse>> Get(
            ...
            IDataSource<IntelliTect.SyncUp.Data.Models.User> dataSource)
        ...
        public virtual Task<ItemResult<UserResponse>> Save(
            ...
            [FromQuery] DataSourceParameters parameters,
            IDataSource<IntelliTect.SyncUp.Data.Models.User> dataSource,
            IBehaviors<IntelliTect.SyncUp.Data.Models.User> behaviors)
            ...
            [FromForm(Name = "role")] RoleParameter role)
        {
            ...
            var _methodResult = await IntelliTect.SyncUp.Data.Models.User.InviteUser(
                Db,
                invitationService,
                _params.Email,
        ...
        public virtual async Task<ItemResult> SetEmail(
            [FromServices] IDataSourceFactory dataSourceFactory,
            [FromServices] IntelliTect.SyncUp.Data.Auth.UserManagementService userService,
            [FromForm(Name = "id")] string id,
        ...
        public virtual async Task<ItemResult> SetPassword(
            [FromServices] IDataSourceFactory dataSourceFactory,
            [FromServices] Microsoft.AspNetCore.Identity.UserManager<IntelliTect.SyncUp.Data.Models.User> userManager,
            [FromServices] Microsoft.AspNetCore.Identity.SignInManager<IntelliTect.SyncUp.Data.Models.User> signInManager,
            [FromForm(Name = "id")] string id,
